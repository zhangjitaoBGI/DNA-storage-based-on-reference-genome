...
segment_length = 543
dest = "E:/work in CNGB/DNA_storage/DNA_storage_reference_genome1/example1/result/{}_validation.bmp".format(img_name)
...
if __name__ == '__main__':
    ...
    decode_method1.decode(dna_path, model_path, txid_and_genome_dict, library_output_path,dest)
