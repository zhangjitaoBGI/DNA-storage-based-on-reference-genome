...
if __name__ == '__main__':
    ...
    '''
    for i in range(1000):
        dest = "E:/work in CNGB/DNA_storage/DNA_storage_reference_genome1/example1/result/validation_replace_simulation/{}/{:0>4}_error_rate_1_100.bmp".format(img_name,i)
        
        decode_method1.decode(dna_path, model_path, txid_and_genome_dict, library_output_path,dest,loss_seq_ratio=0.01)
